...
class NodePanel(QWidget):
    ...
    def _init_ui(self):
        ...
        nodes = [
            ...
            ("音频上传", "audio", "上传音频文件作为输入"),
            ("可灵生视频", "kling_api", "使用可灵AI生成视频"),
            ("即梦生视频", "jimeng_api", "使用即梦AI生成视频"),
            ("Seedance 2.0", "seedance2_api", "支持图生视频/首尾帧/多模态，支持图片+视频+音频参考"),
            ("🖼 生图", "gemini_api", "支持 google/GPT 两种厂商；橙色输入口支持多条连线，最多连14张图片"),
            ("Veo生视频", "veo_api", "支持中文提示词自动转英文"),
            ("✏ 图片修改", "image_edit", "可灵扩图 / 即梦超清 / 即梦局部重绘"),
            ("🧩 图片分镜", "storyboard", "支持图片合成分镜 / 分镜拆解图片"),
            ("📝 文本识图", "text_vision", "使用GPT或Gemini进行图片理解"),
            ("📄 文本显示", "text_display", "显示生成的文本，支持复制"),
